        ...
        const ADMIN_COMPONENTS = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { icon: 'fa-file-signature', name: 'Contract Signature', desc: 'Agreement checkbox & submit', html: `<div class="panel" style="max-width:500px;margin:20px auto"><div class="panel-body"><div style="margin-bottom:16px;font-size:14px;color:var(--muted);display:flex;align-items:flex-start;gap:10px"><input type="checkbox" id="contract-agree" style="margin-top:4px;width:18px;height:18px"><label for="contract-agree" style="line-height:1.5">By checking this box, I acknowledge that I have read, understood, and agree to be bound by the terms and conditions outlined in this contract.</label></div><button class="btn btn-primary btn-submit-contract" style="width:100%;justify-content:center;padding:12px;font-size:15px"><i class="fa-solid fa-file-signature"></i> Sign & Submit Contract</button></div></div>` }
                ]
            }
        ];
